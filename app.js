...
function displayStats() {
    ...
    // const statsString = creatStatsString(headCount, middleCount, bottomCount);

    reportEl.textContent = `You have changed the head ${headCount} times, the body ${middleCount} times, and the legs ${bottomCount} times.`;
}
